...
public class RouteResultPreparation {
	...
	private void ignorePrecedingStraightsOnSameIntersection(List<RouteSegmentResult> result) {
	...
	private TurnType justifyUTurn(List<RouteSegmentResult> result, int i, TurnType t) {
